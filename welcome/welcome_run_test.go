...
func TestRun(t *testing.T) {
	...
	t.Run("should add message and add reaction because message is not found", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.add_handler_on_message_reaction_add"}`, parts[0])
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.add_handler_on_message_reaction_remove"}`, parts[1])
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.adding_messages"}`, parts[2])
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.fetching_messages"}`, parts[3])
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.messages_fetched"}`, parts[4])
		require.JSONEq(t, `{"level":"info","message_title":"my title 1","message":"discord_bot.welcome.adding_missed_messages"}`, parts[5])
		require.JSONEq(t, `{"level":"info","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.adding_message"}`, parts[6])
		require.JSONEq(t, `{"level":"info","message_id":"123","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.message_added"}`, parts[7])
		require.JSONEq(t, `{"level":"info","message_id":"123","message_title":"my title 1","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.adding_reaction"}`, parts[8])
		require.JSONEq(t, `{"level":"info","message_title":"my title 1","message":"discord_bot.welcome.missed_messages_added"}`, parts[9])
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.messages_added"}`, parts[10])
	...
	t.Run("should find message and update roles for users which added reaction on it", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.fetching_messages"}`, parts[3])
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.messages_fetched"}`, parts[4])
		require.JSONEq(t, `{"level":"info","message_id":"104","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.fetching_reactions_message"}`, parts[5])
		require.JSONEq(t, `{"level":"info","role_id":"role-123","role":"my role 1","user_id":"user-id-456","username":"user lambda 456","message":"discord_bot.welcome.adding_user_role_adding"}`, parts[6])
		require.JSONEq(t, `{"level":"info","count_members_reacted":4,"count_members_not_found":1,"message":"discord_bot.welcome.members_not_in_guild"}`, parts[7])
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.messages_added"}`, parts[8])
...
func TestRun_Errors(t *testing.T) {
	...
	t.Run("should return error because fetching messages from channel (ChannelMessages) return error", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","message":"discord_bot.welcome.adding_messages"}`, parts[2])
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.fetching_messages"}`, parts[3])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.messages_fetching_failed"}`, parts[4])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message":"discord_bot.welcome.messages_adding_failed"}`, parts[5])
	...
	t.Run("should return error because adding message in channel (ChannelMessageSendEmbed) return error", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","message_title":"my title 1","message":"discord_bot.welcome.adding_missed_messages"}`, parts[5])
		require.JSONEq(t, `{"level":"info","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.adding_message"}`, parts[6])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.message_adding_failed"}`, parts[7])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message_title":"my title 1","message":"discord_bot.welcome.messages_missed_adding_failed"}`, parts[8])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message":"discord_bot.welcome.messages_adding_failed"}`, parts[9])
	...
	t.Run("should return error because adding reaction on message in channel (MessageReactionAdd) return error", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","message_id":"123","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.message_added"}`, parts[7])
		require.JSONEq(t, `{"level":"info","message_id":"123","message_title":"my title 1","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.adding_reaction"}`, parts[8])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message_id":"123","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.reaction_adding_failed"}`, parts[9])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message_title":"my title 1","message":"discord_bot.welcome.messages_missed_adding_failed"}`, parts[10])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message":"discord_bot.welcome.messages_adding_failed"}`, parts[11])
	...
	t.Run("should return error because fetching all reactions from message (MessageReactionsAll) return error", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","channel_id":"channel-123","channel":"my-channel","message":"discord_bot.welcome.messages_fetched"}`, parts[4])
		require.JSONEq(t, `{"level":"info","message_id":"104","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.fetching_reactions_message"}`, parts[5])
		require.JSONEq(t, `{"level":"error","error":"json unmarshal","message_id":"104","channel_id":"channel-123","channel":"my-channel","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.reactions_message_fetching_failed"}`, parts[6])
		require.JSONEq(t, `{"level":"error","error":"json unmarshal","message_title":"my title 1","message":"discord_bot.welcome.role_updating_failed"}`, parts[7])
		require.JSONEq(t, `{"level":"error","error":"json unmarshal","message":"discord_bot.welcome.messages_adding_failed"}`, parts[8])
		require.Empty(t, parts[9])
	})
	...
	t.Run("should return error because discord_bot.welcome.adding_user_role_adding (GuildMemberRoleAdd) return error", func(t *testing.T) {
		...
		require.JSONEq(t, `{"level":"info","message_id":"104","message_title":"my title 1","channel_id":"channel-123","channel":"my-channel","emoji":"my-emoji-1:emoji-123","message":"discord_bot.welcome.fetching_reactions_message"}`, parts[5])
		require.JSONEq(t, `{"level":"info","role_id":"role-123","role":"my role 1","user_id":"user-id-456","username":"user lambda 456","message":"discord_bot.welcome.adding_user_role_adding"}`, parts[6])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","role_id":"role-123","role":"my role 1","user_id":"user-id-456","username":"user lambda 456","message":"discord_bot.welcome.user_role_adding_failed"}`, parts[7])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message_title":"my title 1","message":"discord_bot.welcome.role_updating_failed"}`, parts[8])
		require.JSONEq(t, `{"level":"error","error":"HTTP 500 Internal Server Error, ","message":"discord_bot.welcome.messages_adding_failed"}`, parts[9])
		require.Empty(t, parts[10])
	})
}
